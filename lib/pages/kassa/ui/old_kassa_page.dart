...
import 'package:qolaily/pages/kassa/provider/old_kassa_provider.dart';

import '../../../shared/default_text.dart';
import '../../../shared/size_config.dart';
import '../../../shared/theme.dart';

class OldKassaPage extends StatelessWidget {
  const OldKassaPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BaseProvider<OldKassaProvider>(
      onReady: (p0) => p0.init(context),
      model: OldKassaProvider(),
